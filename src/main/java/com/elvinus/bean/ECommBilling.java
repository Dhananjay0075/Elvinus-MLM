...
public class ECommBilling {
	...
	public ECommBilling(String first_name, String last_name, String company, String address_1, String address_2,
	...
	public String toString() {
		return "ECommBilling [first_name=" + first_name + ", last_name=" + last_name + ", company=" + company
