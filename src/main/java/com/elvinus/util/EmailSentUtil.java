...
public class EmailSentUtil {
	...
	private static final Logger LOGGER = Logger.getLogger(EmailSentUtil.class);
	
	
	public static String getEmailSent(String emailId,String subject,String messageBody)
	{		 
		    String resetStatus = "";
			...
			try {
				...
				LOGGER.info("Mail Status = "+resetStatus);
	...
	public static String sentEmailWithAttachment(String emailId,String subject,String messageBody,List<String> attachFiles)
	{
		String sentStatus = "";
